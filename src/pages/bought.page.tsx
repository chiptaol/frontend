    ...
    <div className="w-full h-full flex flex-col space-y-16 px-4 py-6">
      ...
      <div className="flex-grow w-full text-center">
        ...
        <h1 className="text-xl font-extrabold mb-6">
          Спасибо что прошли бета-тестирование!
        </h1>
        <p className="text-base font-medium mb-5">
          Сервис находится в стадии открытого бета-тестирования, Мы стараемся
          сделать очень крутой сервис для Вас.
        </p>
        <h4 className="text-base font-extrabold mb-20">
